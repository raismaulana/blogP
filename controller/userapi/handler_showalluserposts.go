...
// showAllUserPostsHandler ...
func (r *Controller) showAllUserPostsHandler(inputPort showalluserposts.Inport) gin.HandlerFunc {

	return func(c *gin.Context) {

		ctx := log.Context(c.Request.Context())

		var req showalluserposts.InportRequest
